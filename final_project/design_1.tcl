...
proc create_root_design { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#Quad SPI Flash#GPIO#SPI 1#SPI 1#SPI 1#SPI 1#UART 0#UART 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#USB\
...
\
  ...
  # Create instance: weights_c1, and set properties
  set weights_c1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 weights_c1 ]
  set_property CONFIG.Memory_Type {True_Dual_Port_RAM} $weights_c1


  # Create instance: weights_c3, and set properties
  set weights_c3 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 weights_c3 ]
  set_property CONFIG.Memory_Type {True_Dual_Port_RAM} $weights_c3


  # Create instance: weights_fc, and set properties
  set weights_fc [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 weights_fc ]
  set_property CONFIG.Memory_Type {True_Dual_Port_RAM} $weights_fc


  # Create interface connections
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA] [get_bd_intf_pins weights_c1/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA1 [get_bd_intf_pins axi_bram_ctrl_2/BRAM_PORTA] [get_bd_intf_pins weights_fc/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_ctrl_1_BRAM_PORTA [get_bd_intf_pins axi_bram_ctrl_1/BRAM_PORTA] [get_bd_intf_pins weights_c3/BRAM_PORTA]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_2/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
